import 'package:ecomm_391/ui/bloc/cart/cart_bloc.dart';
    ...
    return Stack(
      children: [
        ...
        SizedBox(
          ...
          child: Image.network(currentProduct!.image!, fit: BoxFit.fitHeight),
            ...
            child: BlocConsumer<CartBloc, CartState>(
              listener: (_, state){
                ...
                if(state is CartSuccessState){
                  isLoading = false;
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text("Item added to cart"), backgroundColor: Colors.green,),
                  );
                  Navigator.pop(context);
                }
              },
                ...
                return ElevatedButton(
                  onPressed: () {
                    context.read<CartBloc>().add(
                      AddToCartEvent(productId: int.parse(currentProduct!.id), qty: _quantity),
                    );
                  },
